<?php
// Inventory Store API - Stable Server
error_reporting(E_ALL);
ini_set('display_errors', 1);

// Enhanced CORS Headers for Frontend Communication
...
if ($path === 'health' || $path === '') {
    echo json_encode([
        'status' => 'OK',
        'message' => 'Inventory Store API Running',
...
if ($path === 'auth/login' && $method === 'POST') {
    error_log("Login attempt - Path: $path, Method: $method");
